        ...
        <div className="flex h-full items-center overflow-auto p-4 md:py-10">
            <div className="m-auto">
                ...
                <div className="bg-card m-auto mt-8 flex w-full max-w-[800px] items-center rounded-3xl p-4 shadow-2xl">
                    ...
                    <p className="text-sm">
                        Este proyecto analiza la estrategia de comunicación ambiental de Repsol, evaluando la coherencia entre su discurso verde y sus prácticas empresariales. A través del estudio de
                        contenidos oficiales y campañas, se pretende identificar posibles casos de greenwashing y comprender cómo se construye la narrativa ecológica en una gran empresa del sector
                        energético.
                    </p>
                </div>
            </div>
